	...
	SVG.extend(SVG.Element, {
        ...
        draggy: function (constraint) {
            ...
            drag = function(event) {
				...
				if(cecio.ultimo_usato==0) cecio.ultimo_usato =  element.node.id ; 
				
				// console.log(cecio.ultimo_usato);
				...
				// stringa_cont += element.node.id + " - " ; 
				
				//console.log('start drag element');
				// console.log(stringa_cont);
